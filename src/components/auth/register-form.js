...
function RegisterForm({ isAdmin = false }) { // Nueva prop isAdmin
    ...
    return (
        <form action={action} className="flex flex-col gap-5 py-6">
            ...
            {/* Nueva sección para sesiones pagadas */}
               {isAdmin && (
                <div className="flex flex-col gap-3">
                    <label className="text-sm font-medium text-slate-700">Sesiones pagadas</label>
                    <div className="flex flex-wrap gap-4">
                        <label className="flex items-center gap-2">
                            <input type="checkbox" name="paidSessions" value="Pilates" />
                            <span>Pilates</span>
                        </label>
                        <label className="flex items-center gap-2">
                            <input type="checkbox" name="paidSessions" value="Rehabilitacion_funcional" />
                            <span>Rehabilitación Funcional</span>
                        </label>
                        <label className="flex items-center gap-2">
                            <input type="checkbox" name="paidSessions" value="Entrenamiento_personal" />
